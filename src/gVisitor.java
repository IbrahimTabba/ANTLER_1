...
public interface gVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link gParser#select_only}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelect_only(gParser.Select_onlyContext ctx);
	/**
	 * Visit a parse tree produced by {@link gParser#from_only}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFrom_only(gParser.From_onlyContext ctx);
	/**
	 * Visit a parse tree produced by {@link gParser#select_from_only}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelect_from_only(gParser.Select_from_onlyContext ctx);
	/**
	 * Visit a parse tree produced by {@link gParser#having_without_groupby}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHaving_without_groupby(gParser.Having_without_groupbyContext ctx);
	/**
	 * Visit a parse tree produced by {@link gParser#select_star_from_only}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelect_star_from_only(gParser.Select_star_from_onlyContext ctx);
	/**
