...
public interface gListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link gParser#select_only}.
	 * @param ctx the parse tree
	 */
	void enterSelect_only(gParser.Select_onlyContext ctx);
	/**
	 * Exit a parse tree produced by {@link gParser#select_only}.
	 * @param ctx the parse tree
	 */
	void exitSelect_only(gParser.Select_onlyContext ctx);
	/**
	 * Enter a parse tree produced by {@link gParser#from_only}.
	 * @param ctx the parse tree
	 */
	void enterFrom_only(gParser.From_onlyContext ctx);
	/**
	 * Exit a parse tree produced by {@link gParser#from_only}.
	 * @param ctx the parse tree
	 */
	void exitFrom_only(gParser.From_onlyContext ctx);
	/**
	 * Enter a parse tree produced by {@link gParser#select_from_only}.
	 * @param ctx the parse tree
	 */
	void enterSelect_from_only(gParser.Select_from_onlyContext ctx);
	/**
	 * Exit a parse tree produced by {@link gParser#select_from_only}.
	 * @param ctx the parse tree
	 */
	void exitSelect_from_only(gParser.Select_from_onlyContext ctx);
	/**
	 * Enter a parse tree produced by {@link gParser#having_without_groupby}.
	 * @param ctx the parse tree
	 */
	void enterHaving_without_groupby(gParser.Having_without_groupbyContext ctx);
	/**
	 * Exit a parse tree produced by {@link gParser#having_without_groupby}.
	 * @param ctx the parse tree
	 */
	void exitHaving_without_groupby(gParser.Having_without_groupbyContext ctx);
	/**
	 * Enter a parse tree produced by {@link gParser#select_star_from_only}.
	 * @param ctx the parse tree
	 */
	void enterSelect_star_from_only(gParser.Select_star_from_onlyContext ctx);
	/**
	 * Exit a parse tree produced by {@link gParser#select_star_from_only}.
	 * @param ctx the parse tree
	 */
	void exitSelect_star_from_only(gParser.Select_star_from_onlyContext ctx);
	/**
