...
subselect_stmt :
        select_star_from_only |  select_from_only   | having_without_groupby | from_only | select_only |
...
having_without_groupby:
    (T_SELECT | T_SEL) select_list into_clause? from_clause? where_clause? (having_clause | qualify_clause) order_by_clause? select_options?;
